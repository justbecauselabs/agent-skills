...
| expo-ui-best-practices | Design and refine Expo app interfaces when deciding information hierarchy, tap behavior, route-versus-overlay presentation, light and dark mode parity, or visual verification. | `expo-ui-best-practices/SKILL.md` |
...
| typescript | TypeScript best-practices guidance. Use when writing or reviewing TypeScript, choosing function and helper patterns, shaping TypeScript APIs, or running linting workflows. | `typescript/SKILL.md` |
