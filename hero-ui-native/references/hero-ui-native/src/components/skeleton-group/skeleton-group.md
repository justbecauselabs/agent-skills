---
summary: "HeroUI Native Skeleton Group component documentation."
read_when:
  - "Using the HeroUI Native Skeleton Group component"
  - "Need reference details for HeroUI Native Skeleton Group"
---
